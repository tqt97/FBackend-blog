    ...
    <section class="pb-16">
        <div class="container mx-auto">
            <div class="mb-10 flex gap-x-2 text-sm font-semibold">
                <a href="{{ route('post.index') }}" class="opacity-60">Home</a>
                <span class="opacity-30">/</span>
                <a href="{{ route('post.all') }}" class="opacity-60">Blog</a>
                <span class="opacity-30">/</span>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="mt-2">
                                        @foreach ($post->categories as $category)
                                            <a
                                                href="{{ route('category.post', ['category' => $category->slug]) }}">
                                                <span
                                ...
                                <div class="mb-5 flex items-center justify-between gap-x-3 py-5">
                                    <div>
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <span title=""
                                                    class="block max-w-[150px] overflow-hidden text-ellipsis whitespace-nowrap font-semibold"></span>
                                                <span
