                ...
                ->schema([
                    Section::make([
                        Select::make('default_email_provider')
                            ->label(__('admin/setting.default_email_provider'))
                            ->native(false)
                            ->allowHtml()
                            ->preload()
                            ->options(function () {
                            ...
                            ->helperText(__('admin/setting.default_email_provider_helper_text'))
                            ->live()
                            ->columnSpanFull(),
                        Forms\Components\Group::make()
                            ->schema([
                                TextInput::make('smtp_host')
                                    ->label(__('admin/setting.host')),
                                TextInput::make('smtp_port')
                                    ->label(__('admin/setting.port')),
                                Select::make('smtp_encryption')
                                    ->label(__('admin/setting.encryption'))
                                    ->options([
                                        'ssl' => 'SSL',
                                        'tls' => 'TLS',
                                    ]),
                                TextInput::make('smtp_timeout')
                                    ->label(__('admin/setting.timeout')),
                                TextInput::make('smtp_username')
                                    ->label(__('admin/setting.username')),
                                TextInput::make('smtp_password')
                                    ->label(__('admin/setting.password')),
                            ])
                            ->columns(2)
                        ...
                        Forms\Components\Group::make()
                            ->schema([
                                TextInput::make('mailgun_domain')
                                    ->label(__('admin/setting.mailgun_domain')),
                                TextInput::make('mailgun_secret')
                                    ->label(__('admin/setting.mailgun_secret')),
                                TextInput::make('mailgun_endpoint')
                                    ->label(__('admin/setting.mailgun_endpoint')),
                            ])
                            ->columns(1)
                        ...
                        Forms\Components\Group::make()
                            ->schema([
                                TextInput::make('postmark_token')
                                    ->label(__('admin/setting.postmark_token')),
                            ])
                            ->columns(1)
                        ...
                        Forms\Components\Group::make()
                            ->schema([
                                TextInput::make('amazon_ses_key')
                                    ->label(__('admin/setting.amazon_ses_key')),
                                TextInput::make('amazon_ses_secret')
                                    ->label(__('admin/setting.amazon_ses_secret')),
                                TextInput::make('amazon_ses_region')
                                    ->label(__('admin/setting.amazon_ses_region'))
                                    ->default('us-east-1'),
                            ])
                            ->columns(1)
                ...
                ->schema([
                    Section::make([
                        TextInput::make('email_from_name')
                            ->label(__('admin/setting.email_from_name'))
                            ->helperText(__('admin/setting.email_from_name_helper_text')),
                        TextInput::make('email_from_address')
                            ->label(__('admin/setting.email_from_address'))
                            ->helperText(__('admin/setting.email_from_address_helper_text'))
                            ->email(),
                    ]),
                    Section::make()
                        ->schema([
                            TextInput::make('mail_to')
                                ->label(fn () => __('admin/setting.mail_to'))
                                ->hiddenLabel()
                                ->placeholder(fn () => __('admin/setting.mail_to'))
                                ->reactive(),
                            Forms\Components\Actions::make([
                                Forms\Components\Actions\Action::make('Send Test Mail')
                                    ->label(fn () => __('admin/setting.send_test_email'))
